...
<div class="row top_tiles">
   ...
   <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
     <div class="tile-stats">
       ...
       <h3>Pegawai</h3>
       <p>Jumlah seluruh pegawai di Pengadilan Negeri Makale</p>
       <hr>
       <div class="text-center small-box">
...
<div class="row top_tiles">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Pegawai <small>Daftar pegawai pengadilan Negeri Makale</small></h2>
...
<div class="ccol-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_content text-center">
      ...
      <p>Sistem Informasi Pegawai Pengadilan Negeri Makale</p>
      <p></p>
      <p>©<?= date('Y');?> Pengadilan Negeri Makale.</p>
    </div>
  </div>
</div>
</div>
